...
<script type="text/javascript">
	...
	function openUserModifyDialog(){
		...
		$("#address").val(row.location);
		url="../user/register.do?userId="+row.userId;
	}
	...
	<table id="dg" title="用户管理" class="easyui-datagrid"
	 ...
	 <thead>
	 	<tr>
	 		...
	 		<th field="createTime" width="100" align="center">注册日期</th>
	 		<th field="location" width="150" align="center">所在地</th>
	  ...
	  closed="true" buttons="#dlg-buttons">
	 	<form id="fm" method="post">
	 		<table cellspacing="8px">
	 			<tr>
	 				<td>昵称：</td>
	 				<td><input type="text" id="trueName" name="nickName" class="easyui-validatebox" required="true"/></td>
	 				<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	 				<td>账号：</td>
	 			...
	 			<tr>
	 				...
	 				<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	 				<td>联系电话：</td>
	 				<td><input type="text" id="mobile" name="phone" class="easyui-validatebox" required="true"/></td>
	 			</tr>
	 			<tr>
	 				<td>所在地址：</td>
	 				<td colspan="4">
	 					<input type="text" id="address" name="location" class="easyui-validatebox" required="true" style="width: 350px;"/>
	 				</td>
	 			</tr>
	 		</table>
	 	</form>
