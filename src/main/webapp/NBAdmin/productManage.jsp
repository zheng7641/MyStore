...
<script type="text/javascript">
	...
	function deleteProduct(){
		...
		$.messager.confirm("系统提示","您确认要删除这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
			if(r){
				$.post("../deleteGoods.do",{ids:ids},function(result){
					if(result.success){
...
<body style="margin:1px;">
	<table id="dg" title="商品管理" class="easyui-datagrid"
	 ...
	 url="../getGoodsList.do" fit="true" toolbar="#tb">
	 <thead>
	 	<tr>
	 		<th field="cb" checkbox="true" align="center"></th>
	 		<th field="goodsId" width="50" align="center">编号</th>
	 		<th field="imageUrl" width="150" align="center" formatter="formatProPic">商品图片</th>
	 		<th field="goodsName" width="150" align="center">商品名称</th>
	 		<th field="price" width="50" align="center">价格</th>
	 		<th field="quality" width="50" align="center">质量</th>
	 		<th field="tradingPosition" width="100" align="center">交易地点</th>
	 		<th field="contactInformation" width="100" align="center">联系方式</th>
	 		<th field="createTime" width="100" align="center">上传时间</th>
	 		<th field="businessDeal" width="100" align="center">交易方式</th>
	 		<th field="typeName" width="50" align="center">商品类型</th>
	 		<th field="userId" width="50" align="center">卖家昵称</th>
	 	</tr>
	 </thead>
	</table>
